const faqs = [
  {
    q: '1. ทำคลิป/วิดีโอเป็นหลัก ใช้ได้ไหม?',
    a: 'ได้ครับ เล่มนี้สอน "คำ" ที่เป็นแกนของทุกฟอร์แมต — Hook ประโยคแรกใช้เปิดคลิปให้คนหยุดนิ้ว, โครงสคริปต์ (ภาค 4 มีสคริปต์คลิป 60 วิ) และคำปิดการขาย เอาไปใช้กับแคปชั่น คลิป รีลส์ ไลฟ์ ได้ทันที',
  },
  {
    q: '2. เป็นวิดีโอ หรือเนื้อหาอ่าน?',
    a: 'เป็นเนื้อหาอ่านออนไลน์ ออกแบบให้อ่านสั้นๆ และหยิบ Template ไปใช้ได้เร็วกว่าการเปิดดูวิดีโอยาวๆ',
  },
  {
    q: '3. ไม่มีพื้นฐานเขียนหรือการตลาด เรียนได้ไหม?',
    a: 'ได้ครับ เนื้อหาให้สูตร + ตัวอย่างก่อน–หลัง เพื่อให้เริ่มปรับคำกับสินค้าของตัวเองได้ทันที',
  },
  {
    q: '4. อ่านบนมือถือได้ไหม มีวันหมดอายุไหม?',
    a: 'อ่านได้บนมือถือผ่าน LINE / Browser และเข้าถึงได้ตลอดชีพ',
  },
  {
    q: '5. มีตัวอย่างให้เอาไปใช้เลยไหม?',
    a: 'มีครบ ทั้ง 100+ Template, 50+ Hook Formulas และ Prompt Library 30 ชุด',
  },
  {
    q: '6. ใช้กับลูกค้าคนไทยได้จริงไหม?',
    a: 'ตัวอย่างเขียนจากบริบทการขายของออนไลน์ในไทย เน้นภาษาที่คนไทยอ่านแล้วเข้าใจง่าย',
  },
  {
    q: '7. เป็นหนังสือจัดส่งหรือไม่?',
