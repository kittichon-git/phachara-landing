...
| row 2 | B · 100+ Template ครบทุกฟอร์แมต กรอกคำได้ทันที | 490 ฿ |
| row 3 | C · 50+ Hook Formulas พร้อมตัวอย่างไทย | 390 ฿ |
| row 4 | D · Prompt Library 30 ชุด พร้อมตัวอย่างใช้จริง | 290 ฿ |
| row 5 | A · เช็คลิสต์ตรวจงานก่อนปล่อย (Hook / Proof / CTA) | 190 ฿ |
| row 6 | E · ตารางคำต้องห้าม vs คำที่ควรใช้ | 140 ฿ |
